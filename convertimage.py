...
def main():
    ...
    plt.tick_params(labelsize =20,#  Размер подписи
                    color = 'k')   #  Цвет делений
    image1 = cv2.convertScaleAbs(image, alpha=0.03)
    plt.figure(figsize=(15,7))
    ...
    print(image1.dtype)
    try:
        image2=map_uint16_to_uint8(image)
        print(image2)
        plt.figure(figsize=(15,7))
        plt.imshow(image2[0:1000,0:1000],cmap='gray',vmax=image2.max(),vmin=image2.min())
        #plt.grid(True)
        plt.tick_params(labelsize =20,#  Размер подписи
                    color = 'k')   #  Цвет делений
    except:
    ...
    image3= cv2.normalize(image, None, 0, 255, cv2.NORM_MINMAX, dtype=cv2.CV_8U)
    print(image3.dtype)
    plt.figure(figsize=(15,7))
    plt.imshow(image3[0:1000,0:1000],cmap='gray',vmax=image3.max(),vmin=image3.min())
    #plt.grid(True)
    plt.tick_params(labelsize =20,#  Размер подписи
                    color = 'k')   #  Цвет делений
    plt.show()
