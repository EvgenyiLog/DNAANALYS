...
def findcountour(image1,image2):
    ...
    df.to_excel("C:/Users/evgen/Downloads/contourcentrintensivitytiff.xlsx")
    ...
    df.to_excel("C:/Users/evgen/Downloads/contourcentrintensivityrecttiff.xlsx")
            
            
def main():
    image1=readimage("C:/Users/evgen/Downloads/s_1_1102_c.jpg")
    image2=tiffreader("C:/Users/evgen/Downloads/s_1_1102_c.tif")
    imageground(image2)
    
    fig,(ax1,ax2) = plt.subplots(ncols=2)
    ax1.imshow(image1,cmap='gray',vmax=image1.max(),vmin=image1.min())
    ax1.tick_params(labelsize =20,#  Размер подписи
                    color = 'k')   #  Цвет делений
    boxplot_2d(image1[0:int(image1.shape[0]),:],image1[:,0:int(image1.shape[1])],ax=ax2, whis=1.5)
    ...
    print(image2.shape)
    plt.figure(figsize=(15,7))
    plt.imshow(image1[0:1000,0:1000],cmap='gray',vmax=image1.max(),vmin=image1.min())
    #plt.grid(True)
    plt.tick_params(labelsize =20,#  Размер подписи
                    color = 'k')   #  Цвет делений
    
    imageplot3d(image1)
    localstdmean(image1,2)
    findcountour(image1,image2)
