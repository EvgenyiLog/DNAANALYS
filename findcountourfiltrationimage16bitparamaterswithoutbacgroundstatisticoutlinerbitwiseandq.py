...
def filterimage(image,path,k=5):
    'path to file correlate'
    'image filtration'
    'фильтрация возвращает фильтрованное изображение'
    #imagepsnr=cv2.cvtColor(image,cv2.COLOR_RGB2GRAY)
    ...
    #image=np.where(image<np.amax(index99prec),image,0)
...
def findcountour(image1,image2):
    ...
    df.to_excel("C:/Users/evgen/Downloads/contourcentrintensivityfilt16parwithoutbackgroundparametrsbf3.xlsx")
    ...
    df.to_excel("C:/Users/evgen/Downloads/contourcentrintensivityrectfilt16parrectwithoutbackgroundparametrsbf3.xlsx")
...
def main():
    ...
    image=filterimage(image,"C:/Users/evgen/Downloads/s_1_1101_a.jpg")
    imageafter=image
