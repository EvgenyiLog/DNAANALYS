...
def countourfind(image):
    ...
    thresh=cv2.adaptiveThreshold(edges,255,cv2.ADAPTIVE_THRESH_GAUSSIAN_C,cv2.THRESH_BINARY_INV, 3, 1)
    ...
    d={'xcentr':xcentr,'ycentr':ycentr,'areas': areas, 'meanpixel': meanpixel,'sumpixel':sumpixel,'bcenters':bcenters,'acenters':acenters,
