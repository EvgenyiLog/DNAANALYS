...
def findcountour(image1,image2):
    ...
    input = keras.Input(shape=(image1.shape[1],))
    encoded = keras.layers.Dense(encoding_dim, activation='relu')(input)
    decoded = keras.layers.Dense(image1.shape[1], activation='relu')(encoded)
    ...
    autoencoder.save("C:/Users/evgen/Downloads/autoencoderedges.h5")
    autoencoder.save("C:/Users/evgen/Downloads/autoencoderedjes.json")
    try:
        autoencoder.save("C:/Users/evgen/Downloads/autoencoderedjes.yml")
    except:
        pass
