...
def findcountour(image):
    ...
    df.to_excel("C:/Users/evgen/Downloads/contourcentrintensivityafterf.xlsx")
    ...
    df.to_excel("C:/Users/evgen/Downloads/contourcentrintensivityrectafterf.xlsx")
